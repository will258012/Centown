...
* [RGB Blocks](https://www.curseforge.com/minecraft/mc-mods/rgb-blocks)

## 存档安装

在克隆所有文件([在此下载映像文件！](Image/README.md))后，打开`Apply-Image.cmd`，如果成功，存档应该出现在当前目录下的`world`文件夹。

随后将其移动到您的存档文件夹(`saves`)即可。

## 疑难解答

如果您的铁路数据没有被正确加载，那么打开`Fix-railway-data.zip`，按照里面的提示操作。
